...
angular
	.module('app')
	.directive('iuFile', function (SecurityFactory) {
		return {
			restrict: 'E',
			replace: true,
			scope: {
...
angular
	...
	.run(function ($templateCache) {
		$templateCache.put('iuImageBox.html', [
			'<div layout="column" class="re-preview-container" ng-model="' + genReObjId() + '" ng-show="isVisible">',
			'<div class="re-pmd-preview">',
			'<div class="re-pmd-preview-frame">',
			'<iu-file iu-src="reSrc"/>',
			...
			'</div></div><div class="clearfix" style="clear:both"></div></div></div>'
		].join(''));
	});

angular
	.module('app')
	.directive('iuImageBox', function (SecurityFactory, $q, $compile, $timeout) {
		return {
			restrict: 'E',
			templateUrl: function (element, attrs) {
				return 'iuImageBox.html';
			},
			replace: true,
			scope: {
				reSrc: '@'
			...
			link: function (scope, element, attrs, ctrl) {
				...
				scope[attrs.ngModel] = scope.reSrc;
